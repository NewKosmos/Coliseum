...
public class ScreenOffline extends GuiComponent {
	private MasterSlider masterSlider;

	public ScreenOffline(MasterSlider masterSlider) {
		...
		FlounderEvents.addEvent(new IEvent() {
			...
			public boolean eventTriggered() {
				return ScreenOffline.super.isShown() && MasterSlider.BACK_KEY.wasDown();
			}
