...
public class ScreenAddons extends GuiComponent {
	private MasterSlider masterSlider;

	public ScreenAddons(MasterSlider masterSlider) {
		...
		FlounderEvents.addEvent(new IEvent() {
			...
			public boolean eventTriggered() {
				return ScreenAddons.super.isShown() && MasterSlider.BACK_KEY.wasDown();
			}
