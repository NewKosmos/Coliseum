...
import kosmos.entities.editing.particles.*;
...
public class EditorParticleSystem extends IComponentEditor {
	...
	public ComponentParticles component;
	...
	public EditorParticleSystem(Entity entity) {
		this.component = new ComponentParticles(entity, new ArrayList<>(), null, 100.0f, 1.0f, 1.0f);
		this.spawnCentre = new Sphere(0.5f);
		this.renderCentre = true;
	}

	public EditorParticleSystem(IComponentEntity component) {
		this.component = (ComponentParticles) component;
		this.spawnCentre = new Sphere(0.5f);
		this.renderCentre = true;
	}
	...
	@Override
	public ComponentParticles getComponent() {
		return component;
	}
