...
public class ComponentParticles extends IComponentEntity {
	...
	public ComponentParticles(Entity entity, EntityTemplate template) {
		super(entity, ID);
		...
		for (int t = 0; t < templates.length; t++) {
			templateList.add(KosmosParticles.load(templates[t]));
		}
