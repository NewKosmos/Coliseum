...
public class InstanceGemPurple extends Entity {
	...
	private static final TextureObject textureGlow = TextureFactory.newBuilder().setFile(new MyFile(FlounderEntities.ENTITIES_FOLDER, "gemPurple", "gemPurpleGlow.png")).create();
