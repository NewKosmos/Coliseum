...
public class KosmosConfigs {
	...
	public static final ConfigData WATER_REFLECTION_SHADOWS = CONFIG_MAIN.getData(ConfigSection.GRAPHICS, "waterReflectionShadows", true, "If reflection will render shadows. Will decrease performance", KosmosWater::reflectionShadows);
