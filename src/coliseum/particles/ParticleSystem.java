...
public class ParticleSystem {
	...
	public ParticleSystem(List<ParticleTemplate> types, IParticleSpawn spawn, float pps, float speed, float gravityEffect) {
		...
		ColiseumParticles.addSystem(this);
	}
	...
	private void emitParticle() {
		...
		ColiseumParticles.addParticle(emitType, spawnPos, velocity, lifeLength, generateRotation(), scale, gravityEffect);
	}
	...
	public void delete() {
		ColiseumParticles.removeSystem(this);
	}
}
