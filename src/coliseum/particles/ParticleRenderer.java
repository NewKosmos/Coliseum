...
public class ParticleRenderer extends IRenderer {
	...
	public void renderObjects(Vector4f clipPlane, ICamera camera) {
		if (!shader.isLoaded() || ColiseumParticles.getParticles() == null) {
			return;
		}

		prepareRendering(clipPlane, camera);

		for (StructureBasic<Particle> list : ColiseumParticles.getParticles()) {
	...
	@Override
	public void profile() {
		FlounderProfiler.add(ColiseumParticles.PROFILE_TAB_NAME, "Render Time", super.getRenderTime());
	}
