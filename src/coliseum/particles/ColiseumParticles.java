 ...
 */
public class ColiseumParticles extends IModule {
	private static final ColiseumParticles INSTANCE = new ColiseumParticles();
	...
	public static ParticleTemplate load(String name) {
		...
		if (data == null) {
			...
			MyFile saveFile = new MyFile(ColiseumParticles.PARTICLES_LOC, name + ".particle");
